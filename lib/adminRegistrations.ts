...
export type AdminRegistration = {
  ...
  payment_deadline_extended_by: string | null;
  payment_deadline_extension_reason: string | null;
  late_entry_required: boolean;
  late_entry_flagged_at: string | null;

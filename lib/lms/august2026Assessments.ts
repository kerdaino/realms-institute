...
const discipleshipShells: August2026AssessmentShell[] = [
  ...
  shell({ stableId: "1ebef6ec-bf91-541c-8e77-4022c807264c", courseCode: "RSD-DIS 108", route: "foundational", title: "Week 7 — Foundational Integration & Final Route Assessment", assignmentType: "project", assessmentDomain: "discipleship", assessmentCategory: "final_route_assessment", evidencePurpose: "Programme integration and final route evidence based on the approved Foundational teaching record.", weightUnits: 1, requiredForGraduation: true, maxSubmissionAttempts: 2, submissionRequirements: textOnly, rubricKey: "discipleship" }),
  ...
  shell({ stableId: "4faf3dde-bd4d-50d5-9dbb-f7a39d423537", courseCode: "RSD-ADV 205", route: "advanced", title: "Week 7 — Advanced Integration & Final Route Assessment", assignmentType: "project", assessmentDomain: "discipleship", assessmentCategory: "final_route_assessment", evidencePurpose: "Programme-wide Advanced integration and final route evidence. This is not an ADV206 course.", weightUnits: 1, requiredForGraduation: true, maxSubmissionAttempts: 2, submissionRequirements: textOnly, rubricKey: "discipleship" }),
];
...
const webShells = [
  ...
  ["RSD-WEB 108", "Week 7 — Project Delivery and Stewardship Reflection", "time_management", "time_management", "Time-management, project-delivery and stewardship workflow evidence.", textOnly, "professional_workflow", "103dae0d-8202-5eb9-b92d-ffc6b0ebac62"],
] as const;
...
const cyberShells = [
  ...
  ["RSD-CYB 108", "Week 7 — Professional Discipline and Workflow Reflection", "time_management", "time_management", "Time-management, focus and professional-discipline workflow evidence.", textOnly, "professional_workflow", "0914e648-d280-5339-bee4-38a47387b8eb"],
] as const;

function skillShells(route: "web" | "cyber", definitions: typeof webShells | typeof cyberShells): August2026AssessmentShell[] {
  return definitions.map(([courseCode, title, assignmentType, assessmentCategory, evidencePurpose, submissionRequirements, rubricKey, stableId]) => shell({ stableId, courseCode, route, title, assignmentType, assessmentDomain: "skill", assessmentCategory, evidencePurpose, weightUnits: 1, requiredForGraduation: false, maxSubmissionAttempts: 2, submissionRequirements, rubricKey }));
}

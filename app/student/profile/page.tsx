...
export default async function StudentProfilePage() {
  ...
  const [data, handbook] = await Promise.all([
    getStudentDashboardData(user.id),
    getStudentHandbookState(user.id),
  ]);

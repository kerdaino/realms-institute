...
export default async function StudentCalendarPage() {
  ...
  return <><PageHeading eyebrow="Student Portal" title="Schedule" description="Class sessions from your enrolled courses, shown in chronological order." /><div className="space-y-6"><StudentPanel title="Upcoming"><SessionList sessions={upcoming} empty="No upcoming class sessions have been published yet." /></StudentPanel><StudentPanel title="Past"><SessionList sessions={data.pastSessions} empty="No past class sessions are available yet." /></StudentPanel>{unscheduled.length ? <StudentPanel title="Schedule Pending" description="These enrolled class sessions do not yet have a published date."><SessionList sessions={unscheduled} empty="" /></StudentPanel> : null}</div></>;
}

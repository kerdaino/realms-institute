    ...
    <SectionContainer id="contact" labelledBy="contact-title" className="pb-24 pt-16 md:pt-24">
      <div className={realmClasses.container}>
        <div className="rounded-[var(--realm-radius-xl)] border border-[var(--realm-border-strong)] bg-[#0a1930] p-7 shadow-[var(--realm-shadow-md)] md:p-12">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[var(--realm-gold-soft)]">Registration Open</p>
          ...
          <p className="mt-5 max-w-3xl text-base leading-8 text-[var(--realm-muted)] md:text-lg">Applications are now open for the next REALMS School of Discovery cohort. Choose Web Development or Cybersecurity Foundations as your practical skill pathway.</p>

    ...
    <SectionContainer id="contact" labelledBy="contact-title" className="pb-24 pt-16 md:pt-24">
      <div className={realmClasses.container}>
        <div className="rounded-[var(--realm-radius-xl)] border border-[var(--realm-border-strong)] bg-[#0a1930] p-7 shadow-[var(--realm-shadow-md)] md:p-12">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[var(--realm-gold-soft)]">Registration Open · August 2026</p>
          ...
          <p className="mt-5 max-w-3xl text-base leading-8 text-[var(--realm-muted)] md:text-lg">Applications are open for the August 2026 School of Discovery cohort. Complete one approved discipleship route and choose Web Development or Cybersecurity Foundations as your practical skill pathway.</p>

...
export function PaymentVerification({ reference }: { reference: string }) {
  ...
  return <Status title="Payment Confirmed" copy="Your registration payment has been confirmed. REALMS Institute will contact you with onboarding details for the next cohort." reference={state.reference} registration={state.registration} payment={state.payment} registrationSave={state.registrationSave} emailStatus={state.emailStatus} />;
}

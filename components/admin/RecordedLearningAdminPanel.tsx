...
export function RecordedLearningAdminPanel({ sessionId, recordings, requirements, policy, courseCategory, assignmentCount, assessmentAssignments, assessmentQuizzes }: {
  ...
  return <div className="space-y-5">
    ...
    <form onSubmit={(event) => {
      ...
      {[
        ["requires_checkpoints", "Requires checkpoints", defaults.requiresCheckpoints], ["requires_quiz", "Requires quiz (Build 8)", defaults.requiresQuiz], ["requires_practical", "Requires practical (Build 8)", defaults.requiresPractical], ["requires_reflection", "Requires reflection", defaults.requiresReflection], ["requires_oral_verification", "Requires oral verification", defaults.requiresOral], ["allow_late_completion", "Allow late completion", defaults.allowLate],
